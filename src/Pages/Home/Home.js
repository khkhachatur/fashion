    ...
    <div style={{
      ...
      <div style={{
        ...
        <ul style={{
            ...
            <li><strong>Information about POMMIE: </strong> Pommie, the premier destination for high-end Armenian designers, makes its long-awaited debut, introducing ‘Made In Armenia’ to the US market. The first of its kind, the boutique luxury retailer offers an exclusively curated collection of highly coveted pieces, including ready-to-wear and accessories by leading and emerging designers from the highlands.</li>
        ...
        <ul style={{listStyleType:'none', padding:'0', display:'flex', flexDirection:'column', gap:'50px'}}>
            <li style={{border:'none', borderBottom:'2px solid', borderRadius:'5px'}}>
                <Brand
